...
object DataDummy {
    ...
    fun generateDummyWithId(course: LocalData, bookmarked: Boolean): LocalData {
        course.bookmarked = bookmarked
        return  course
    }

    fun generateMovieData(): List<LocalData> {
        val movie = ArrayList<LocalData>()
        val movieData =
            arrayOf(
                arrayOf(
                    "330457",
                ...
                arrayOf(
                    ...
                    "4.7",
                    "en",
                    "/r15SUgzjL8bablcdEkHk9T7TSRl.jpg"
                ),
                arrayOf(
                    "429617",
                ...
                arrayOf(
                    ...
                    "3.6",
                    "en",
                    "/4I0CQfnMy6sRR7QhgqsXR16TmIs.jpg"
                ),
                arrayOf(
                    "423204",
                    "Angel Has Fallen",
                ...
                arrayOf(
                    ...
                    "6.6",
                    "en",
                    "/ivymBQYzYqZoLhvgYg77gSzXKsA.jpg"
                ),
                arrayOf(
                    "449924",
                    "Ip Man 4: The Finale",
                ...
                arrayOf(
                    ...
                    "8.4",
                    "en",
                    "/q125RHUDgR4gjwh1QkfYuJLYkL.jpg"
                ),
                arrayOf(
                    "476631",
                    ...
                    "6.5",
                    "en",
                    "/3HbGrs1V1QS9kxjzPagMZaSxhKK.jpg"
                )
            )
        for (i in 0 until 20){
            ...
            movie.add(
                LocalData(
                    ...
                    data[4],
                    true,
                    "https://image.tmdb.org/t/p/w185"+data[6],
                    data[3]
                )
            )
    ...
    fun generateTvShowData(): List<LocalData> {
        val tvShow = ArrayList<LocalData>()
        ...
        val tvShowData =
            arrayOf(
                ...
                arrayOf(
                    ...
                    "7.3",
                    "en",
                    "/reKs8y4mPwPkZG99ZpbKRhBPKsX.jpg"
                ),
                arrayOf(
                    "1434",
                    "Family Guy",
                ...
                arrayOf(
                    ...
                    "7",
                    "en",
                    "/bgbQCW4fE9b6wSOSC6Fb4FfVzsW.jpg"
                ),
                arrayOf(
                    "79460",
                    "Legacies",
                    ...
                    "7.8",
                    "en",
                    "/rb64COqdpRRfWOc6gWTfC7WxzXP.jpg"
                ),
                arrayOf(
                    "1416",
                    "Grey's Anatomy",
    ...
    fun generateFakeTvShowData(): ArrayList<ContentResponse> {
    ...
    fun generateFakeMovie(): ArrayList<ContentResponse> {
        val movie = ArrayList<ContentResponse>()
